    ...
    public function show(Request $request, CrawledPage $crawledPage): JsonResponse
    {
        ...
        return response()->json([
            'data' => [
                ...
                'knowledge_type' => $crawledPage->knowledge_type?->value,
                'kind' => $crawledPage->kind,
                'standard_code' => $crawledPage->standard_code,
                'standard_edition' => $crawledPage->standard_edition,
                'standard_issuer' => $crawledPage->standard_issuer,
                'standard_status' => $crawledPage->standard_status,
                'standard_publication_date' => $crawledPage->standard_publication_date?->toDateString(),
                'standard_review_date' => $crawledPage->standard_review_date?->toDateString(),
                'rights_basis' => $crawledPage->rights_basis,
