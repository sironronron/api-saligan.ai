...
<div style="padding: 40px 40px 8px 40px;">
    ...
    <!-- Greeting -->
    <h1 style="margin: 0 0 16px 0; font-family: 'Fraunces', Georgia, 'Times New Roman', serif; font-size: 26px; font-weight: 700; color: #1D4533; line-height: 1.3;">Confirm your email</h1>
    ...
    <p class="email-copy" style="margin: 0 0 16px 0; font-family: 'Inter', -apple-system, 'Segoe UI', sans-serif; font-size: 16px; line-height: 1.65; color: #5E3122;">
        You're one step away from researching Philippine law with Batayan.ai. Confirm that <strong style="color: #1D4533;">{{ $email }}</strong> belongs to you to finish setting up your account.
    </p>
    ...
    <p class="email-copy" style="margin: 0 0 24px 0; font-family: 'Inter', -apple-system, 'Segoe UI', sans-serif; font-size: 16px; line-height: 1.65; color: #5E3122;">
        The link expires after a short while, and can only be used once. If you did not create an account with us, you can safely ignore this email.
    </p>
    ...
    <p style="margin: 0 0 32px 0; font-family: 'Inter', -apple-system, 'Segoe UI', sans-serif; font-size: 13px; line-height: 1.5;">
        <a href="{{ $confirmationUrl }}" style="color: #1D4533; text-decoration: underline; word-break: break-all;">{{ $confirmationUrl }}</a>
    </p>
